        ...
        <div className="card-content-text-box">
          ...
          <div className="features-act-box">
            <div className="post-act-btn">
              <button className="act-btn eye-btn">
                <FiEye />
              </button>
              <button className="act-btn share-btn">
                <Image
                  src="/image/sync-icons.svg"
                  width={17}
                  height={17}
                  preview={false}
                  alt="blogs card image"
              ...
              <button className="act-btn react-btn">
                <FiHeart />
              </button>
            </div>
