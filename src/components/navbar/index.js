          ...
          <div className="header-main-wrapper">
             ...
             <Logo logoType='secondary-logo'  src='/image/logo_dark2.png.svg' Width='112' height='55' alt='header brand logo' />
              ...
              <nav className="navbar-nav-box">
                <ul className="nav-item-box">
                  ...
                  <li className="nav-list"><Linked href={'/search'} title="Search" /></li>
                  <li className="nav-list"><Linked href={'/pricing'} title="Pricing" /></li>
                  <li className="nav-list"><Linked href={'/about'} title="About" /></li>
                </ul>
              </nav>
            </div>
            ...
            <div className="header-button-content">
              <div className="nav-auth-btn-widgets">
                <span className="auth-user-icons"><AiOutlineUser /></span>
              ...
              <div className="post-ad-button"><Button butVerient='primary-button' btnText='Post Your Ad' btnsIcon={<AiOutlinePlus />} /></div>
            </div>
          </div>
        ) : (
          <div className="header-main-wrapper header-mobile-version">
          <div className="mobo-left-content">
            <button type="primary" onClick={showDrawer} className="nav-trigger-btn-widgets">
                <span className="trigger-user-icons"><HiBars3 /></span>
            </button>
            <Drawer placement="left" onClose={onClose} open={open} className="left-content-mobo">
              <nav className="navbar-nav-box">
                <ul className="nav-item-box">
                  <li className="nav-list"><Linked href={'/'} title="Home" /></li>
                  <li className="nav-list"><Linked href={'/search'} title="Search" /></li>
            ...
            <div className="nav-auth-btn-content">
              <button type="primary" onClick={showDrawer2} className="nav-auth-btn-widgets">
                <span className="auth-user-icons"><AiOutlineUser /></span>
              </button>
              <Drawer placement="right" onClose={onClose} open={open2} className="right-content-mobo">
                <div className="auth-user-btn">
                  <button className="auth-btn log-user-btn">Log In</button>
                  <span className="divider"></span>
                  <button className="auth-btn reg-user-btn">Register</button>
