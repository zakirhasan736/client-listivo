    ...
    >
        <SwiperSlide>
            <div className='service-slide-items'>
                <Image src='/image/overview-product-slider1.png' width={717} height={475} alt='service provider image' />
            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='service-slide-items'>
                <Image src='/image/overview-product-slider2.png' width={717} height={475} alt='service provider image' />
            </div>
        </SwiperSlide>
        <SwiperSlide>
            <div className='service-slide-items'>
...
export default ProviderProductSlider
